...
public class ItemDAOImpl implements ItemDAO {
    ...
    public Item search(String code) throws SQLException, ClassNotFoundException {
        ...
        rst.next();
        return new Item(code, rst.getString("description"), rst.getInt("packSize"), rst.getBigDecimal("unitPrice"),rst.getInt("qtyOnHand"));
    }
    ...
    public ArrayList<Item> getAll() throws SQLException, ClassNotFoundException {
        ...
        while (rst.next()) {
            allItems.add(new Item(rst.getString("itemCode"), rst.getString("description"),  rst.getInt("packSize"),rst.getBigDecimal("unitPrice"), rst.getInt("qtyOnHand")));
        }
        return allItems;
    }
